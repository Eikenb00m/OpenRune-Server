 ...
 */
data class ForcedMovement internal constructor(
    private val initialTile: Tile,
    internal val destinations: Array<Tile>,
    internal val clientDuration1: Int,
    internal val clientDuration2: Int,
